...
<div class="row">
	<div class="col-md-6 col-lg-6">
		<div class="jumbotron">
			...
			<hr class="my-4">
			<p>Start learning about how to use Eval SQL.NET with our getting started tutorial.</p>
			<p class="lead">
	...
	<div class="col-md-6 col-lg-6">
		<div class="jumbotron">
			...
			<hr class="my-4">
			<p>Start learning the common API of Eval SQL.NET, and everything around it.</p>
			<p class="lead">
	...
	<div class="col-md-6 col-lg-6">
		<div class="jumbotron">
			...
			<hr class="my-4">
			<p>Start learning Eval SQL.NET best practices and solution to the common problem you may encounter.</p>
			<p class="lead">
